...
namespace Mango.Services.OrderAPI.Controllers
{
    ...
    public class OrderAPIController : ControllerBase
    {
        ...
        public OrderAPIController(IProductService productService, IMapper mapper, ApplicationDbContext db, IRabbitMQOrderMessageSender messageBus, IConfiguration configuration)
        {
            _db = db;
            _mapper = mapper;
        ...
        public async Task<ResponseDto> ValidateStripeSession([FromBody] int OrderHeaderId)
        {
            ...
            try
            {
                ...
                if(paymentIntent.Status == "succeeded") // the status is from stripe docs
                {
                    ...
                    _messageBus.SendMessage(rewardsDto, _configuration.GetValue<string>("TopicsAndQueueNames:OrderCreatedTopic"));
                    _response.Result = _mapper.Map<OrderHeaderDto>(orderHeader) ;
